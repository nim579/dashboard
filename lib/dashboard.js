...
Dashboard.View = (function(superClass) {
  ...
  View.prototype.template = '<div class="container"></div>';

  View.prototype.widgetTemplate = '<div class="element w-3 h-2"><div class="element-wrap"></div></div>';
  ...
  View.prototype.render = function() {
    var $container, $widget, i, len, model, ref;
